@extends('layout.app')
@section('title', 'Contact Us - Wishery')
@section('content')
  <!-- Inner Page Banner -->
    ...
    <div class="row g-5">
      ...
      <div class="col-lg-6">
        <div class="contact-info">
          <!-- <h4>Get in Touch</h4> -->
          <p><i class="bi bi-geo-alt-fill me-2"></i> SRM Road, Near Nirmala Sisu Bhavan, <br> Ayyappankavu, Ernakulam, Kerala 682018</p>
          ...
          <!-- Google Map -->
          <div class="map mt-4">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5638.084165195368!2d76.27771669839113!3d9.995059800000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080db7c57b631b%3A0x4e2c7d1c34a19539!2sInnerspace%20Coworking!5e1!3m2!1sen!2sin!4v1756288181102!5m2!1sen!2sin" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </div>
<div class="col-lg-6">
