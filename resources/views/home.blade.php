    ...
    color: #e2ba46;
      ...
      <section class="blue-bg" style="background:#0a1851;">
          <div class="container">
               ...
               <p class="mt-4">At Wishery, we blend smart social media marketing with creative production that truly connects. We don’t just create things that look cool. We make stuff that gets results. That’s what makes us different!</p>
            </div>
      </section>
      <!-- Clients -->
      ...
      <section id="portfolio" class="blue-bg">
         <div class="container ">
            <h2>Portfolio</h2>
            <a href="{{url('portfolio')}}"><div class="iso-grid  position-relative" id="isoGrid">
            </div></a>
         </div>
         <div class=""></div>
    ...
    <div class="row align-items-center justify-content-start m-0">
      ...
      <div class="col-lg-6 mb-6 mb-lg-0 text-start left-info">
        ...
        <div class="contact-info">
          <p><strong>Address:</strong><br>SRM Road, Near Nirmala Sisu Bhavan, <br>Ayyappankavu, Ernakulam, Kerala 682018</p>
        ...
        <div class="social_wrap social_footer">
          <a href="https://www.linkedin.com/company/iuhaa-wishery-pvt-ltd/" target="_blank"><i class="fab fa-linkedin"></i></a>
