...
<head>
  <!-- Google Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-T0VR46PPF4"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag() { dataLayer.push(arguments); }
    gtag('js', new Date());
    gtag('config', 'G-T0VR46PPF4');
  </script>
  <!-- Google Tag Manager -->
  <script>(function (w, d, s, l, i) {
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-K2NX6Q5Z');</script>
  ...
  <link rel="stylesheet" href="{{ asset('assets/wishery/style.css') }}?v={{ file_exists(public_path('assets/wishery/style.css')) ? filemtime(public_path('assets/wishery/style.css')) : time() }}">
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K2NX6Q5Z" height="0" width="0"
